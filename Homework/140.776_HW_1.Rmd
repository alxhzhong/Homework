...
9. I used an **inappropriately-sized legend**. Placing the legend in an appropriate location at a readable yet small size will draw more attention to the trends presented in the plot.
