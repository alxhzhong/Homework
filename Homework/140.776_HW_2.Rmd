...
df <- rainfall %>% 
  ...
  select(-c(month, day)) %>% 
  inner_join(temperature, by = join_by(city_name, date))
...
Using this newly joined dataset, let's plot rainfall over time.
...
df %>% 
  ...
  labs(
    ...
    subtitle = "Temperatures steadily fluctuate by year; Canberra and Sydney have the most intra-year variation",
    x = "Year",
    y = "Temperature (°C)",
